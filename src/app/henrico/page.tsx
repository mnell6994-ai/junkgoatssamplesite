...
export const metadata = {
  title: "Junk Removal Henrico VA | Professional Junk Removal Services in Henrico County Virginia",
  description: "Professional junk removal services in Henrico County, VA. Junk removal, furniture removal, estate cleanout, construction debris, and more. Licensed, insured, locally owned. Free estimates!",
...
export default function HenricoPage() {
  const services = [
    {
      name: "Junk Removal",
      description: "Complete junk removal service for homes and businesses throughout Henrico County",
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto font-semibold">
                Henrico County's most trusted junk removal company. We've been serving Glen Allen, Short Pump, Tuckahoe, and surrounding areas for years with professional, reliable, and affordable junk removal services.
              </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-[#1e40af] mb-6">
                Local Henrico County Junk Removal Experts
              </h3>
              <p className="text-base md:text-lg text-gray-600 mb-6">
                As a locally owned and operated business, we understand Henrico County's diverse communities and unique needs. 
                From family homes in Glen Allen to bustling commercial areas in Short Pump, we have the experience and knowledge 
                to handle any junk removal job safely and efficiently.
              </p>
              <p className="text-base md:text-lg text-gray-600 mb-6">
                Henrico County's rapid growth has created a mix of established neighborhoods and new developments. Whether you're 
                dealing with estate cleanouts in Tuckahoe, furniture removal from Glen Allen homes, or construction debris 
                from Short Pump commercial projects, our Henrico junk removal experts understand the county's unique landscape.
              </p>
              <p className="text-base md:text-lg text-gray-600 mb-6">
                We serve all Henrico County areas including Glen Allen, Short Pump, Tuckahoe, Lakeside, and Innsbrook. 
                Our local knowledge helps us provide faster service and better pricing than companies that don't 
                understand Henrico's specific zoning and disposal requirements.
              </p>
              <ul className="space-y-3">
                {[
                  "Licensed, bonded, and fully insured",
                  "Years of experience serving Henrico County", 
            ...
            <div className="relative w-full h-64 md:h-96">
              <Image 
                src="/images/henrico-county-update.jpg" 
                alt="Henrico County junk removal professionals at work"
                fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-center mb-12 uppercase tracking-tight">
                ...
                <span className="text-[#dc2626]">HENRICO COUNTY</span>{" "}
            ...
            <Card className="bg-white overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                <Image
                  ...
                  alt="Junk Removal Henrico County"
                  width={400}
                  height={250}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#dc2626] mb-3">Junk Removal</h3>
                  <p className="text-gray-600 mb-4">
                    Complete junk removal service for homes and businesses throughout Henrico County. We handle all types of unwanted items safely and efficiently. 
                    From single item pickups to full house cleanouts, our Henrico County team provides professional junk removal services across all areas 
                    including Glen Allen, Short Pump, Tuckahoe, and Lakeside.
                  </p>
            ...
            <Card className="bg-white overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                <Image
                  ...
                  alt="Furniture Removal Henrico County"
                  width={400}
                  height={250}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#dc2626] mb-3">Furniture Removal</h3>
                  <p className="text-gray-600 mb-4">
                    ...
                    Henrico County's diverse housing includes everything from modern Short Pump homes to historic Tuckahoe properties, 
            ...
            <Card className="bg-white overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                <Image
                  ...
                  alt="Construction Debris Removal Henrico County"
                  width={400}
                  height={250}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#dc2626] mb-3">Construction Debris</h3>
                  <p className="text-gray-600 mb-4">
                    ...
                    Henrico County's booming construction market means lots of renovation projects. Whether you're a contractor working on 
                    Short Pump office buildings or a homeowner renovating a Glen Allen home, we can handle your construction debris.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-center gap-2 text-sm text-gray-700">
                      <Check className="w-4 h-4 text-green-500" />
            ...
            <Card className="bg-white overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                <Image
                  ...
                  alt="Appliance Removal Henrico County"
                  width={400}
                  height={250}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#dc2626] mb-3">Appliance Removal</h3>
                  <p className="text-gray-600 mb-4">
                    Safe appliance removal including refrigerators, washers, dryers, and more. We handle all appliance types with care. 
                    Henrico County's diverse housing stock means appliances of all sizes and ages. From modern condos in Short Pump to 
                    established homes in Tuckahoe, we safely remove and properly dispose of all appliance types.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-center gap-2 text-sm text-gray-700">
                      <Check className="w-4 h-4 text-green-500" />
            ...
            <Card className="bg-white overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                <Image
                  ...
                  alt="Estate Cleanout Henrico County"
                  width={400}
                  height={250}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#dc2626] mb-3">Estate Cleanout</h3>
                  <p className="text-gray-600 mb-4">
                    Complete estate cleanout services for homes and properties. We handle sensitive situations with care and professionalism. 
                    Henrico County's established neighborhoods are filled with homes that have been in families for generations. When the time comes 
            ...
            <Card className="bg-white overflow-hidden hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                <Image
                  ...
                  alt="Yard Waste Removal Henrico County"
                  width={400}
                  height={250}
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#dc2626] mb-3">Yard Waste Removal</h3>
                  <p className="text-gray-600 mb-4">
                    Yard waste and debris removal for residential properties. We handle all types of yard debris and seasonal cleanup. 
                    Henrico County's mature trees and well-landscaped properties create beautiful neighborhoods, but they also generate lots of yard waste. 
                    From fallen branches in Glen Allen to seasonal cleanup in Short Pump, we help keep Henrico County's neighborhoods clean and beautiful.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-center gap-2 text-sm text-gray-700">
                      <Check className="w-4 h-4 text-green-500" />
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-8 p-6 bg-white rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-[#1e40af] mb-4 text-center">Henrico County Areas We Serve</h3>
            <p className="text-gray-600 mb-4 text-center">
              Junk Goats proudly serves all Henrico County areas with our professional junk removal services. 
              Our local Henrico County team understands the unique characteristics of each area and provides tailored 
              services to meet the specific needs of residents and businesses throughout the county.
            </p>
            <p className="text-gray-600 mb-4">
              <strong>Glen Allen:</strong> Known for its family-friendly neighborhoods and excellent schools, we provide 
              comprehensive junk removal services for homes and businesses in this growing community.
            </p>
            <p className="text-gray-600 mb-4">
              <strong>Short Pump:</strong> This bustling commercial and residential hub often needs commercial junk removal services. 
              We help local businesses maintain clean storefronts and remove old fixtures and equipment.
            </p>
            <p className="text-gray-600 mb-4">
              <strong>Tuckahoe:</strong> Henrico County's established neighborhood requires careful handling of older properties. 
              Our team respects the architectural integrity while providing efficient junk removal services.
            </p>
            <p className="text-center mt-6 text-gray-600">
              Don't see your area? We serve all of Henrico County and surrounding areas. 
      ...
      <section id="contact" className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-5xl font-black text-center mb-12 uppercase tracking-tight">
            ...
            <span className="text-[#1e40af]">YOUR HENRICO COUNTY PROPERTY?</span>
          </h2>
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white">
                  <CardContent className="p-6">
                    <h4 className="text-xl font-bold text-[#1e40af] mb-4">Henrico County Service Areas</h4>
                    <p className="text-gray-600 mb-3">
                      We proudly provide junk removal services throughout Henrico County and surrounding areas including:
                    </p>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      {["Glen Allen", "Short Pump", "Tuckahoe", "Lakeside", "Innsbrook", "West End", "Near West End", "Wyndham"].map((area) => (
