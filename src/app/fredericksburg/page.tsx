      ...
      <div className="bg-white border-b border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 text-sm">
            ...
            <Link href="/fredericksburg" className="text-[#4a7c59] font-semibold">Fredericksburg</Link>
      ...
      <section className="bg-[#f5f1ed] py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-[#2d3e2d] mb-4">
            Sauna Rentals in Fredericksburg, VA
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Premium mobile sauna experiences in Virginia&apos;s historic gem and gateway to Northern Virginia
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold text-[#4a7c59] mb-6">
                Mobile Sauna Rentals in Fredericksburg
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Welcome to On-The-Go Saunas in Fredericksburg, Virginia. This charming historic city, known for its rich Civil War history and beautiful Rappahannock River, provides the perfect setting for authentic wellness experiences. Whether you&apos;re exploring the historic downtown, visiting the University of Mary Washington, or enjoying the local arts scene, our mobile saunas bring relaxation and wellness directly to your location.
              </p>

              <h3 className="text-2xl font-bold text-[#4a7c59] mb-4">
                Why Choose On-The-Go Saunas in Fredericksburg?
              </h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Fredericksburg&apos;s unique blend of historic charm, vibrant community, and natural beauty makes it an ideal location for wellness experiences. Our wood-burning saunas complement the area&apos;s historic character while providing modern wellness benefits. We serve the entire Fredericksburg area, from downtown to the surrounding Spotsylvania County.
              </p>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-[#4a7c59]">Historic charm:</strong> Perfect for events at historic venues and downtown locations
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#4a7c59] flex-shrink-0 mt-1" />
                  <div>
                    <strong className="text-[#4a7c59]">University ready:</strong> Great for UMW events, student wellness programs, and campus activities
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#4a7c59] flex-shrink-0 mt-1" />
                  <div>
                    <strong className="text-[#4a7c59]">Arts community:</strong> Perfect for gallery openings, cultural events, and creative gatherings
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#4a7c59] flex-shrink-0 mt-1" />
                  <div>
                    <strong className="text-[#4a7c59]">Riverside setting:</strong> Beautiful locations along the Rappahannock River
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[#4a7c59] flex-shrink-0 mt-1" />
                  <div>
                    <strong className="text-[#4a7c59]">Convenient access:</strong> Easy access from Northern Virginia and Richmond areas
                  </div>
                </li>
              </ul>

              <h3 className="text-2xl font-bold text-[#4a7c59] mb-4">
                Perfect for Fredericksburg&apos;s Community
              </h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Fredericksburg residents enjoy a rich cultural life with art galleries, historic sites, and community events. Our sauna rentals are perfect for post-exploration relaxation after visiting the Fredericksburg & Spotsylvania National Military Park, unwinding after a day of shopping in historic downtown, or adding a unique element to your special events.
              </p>

              <h3 className="text-2xl font-bold text-[#4a7c59] mb-4">
                Historic Venue Events
              </h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Fredericksburg&apos;s historic venues and beautiful riverfront locations provide stunning backdrops for sauna experiences. Many of our clients book sauna rentals for weddings at historic properties, corporate events at downtown venues, or special celebrations that complement the city&apos;s historic charm.
              </p>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                With the University of Mary Washington and numerous businesses in the area, we frequently serve academic events, corporate retreats, and professional gatherings. Our saunas are perfect for team building, wellness programs, and unique event experiences that stand out in this historic setting.
              </p>

              <Card className="bg-gradient-to-r from-[#4a7c59] to-[#6a9c79] text-white">
                <CardContent className="p-8 text-center">
                  <h2 className="text-3xl font-bold mb-4">Ready to Book Your Fredericksburg Sauna Rental?</h2>
                  <p className="text-lg mb-6">Contact us today to check availability and book your sauna experience in Virginia&apos;s historic gem</p>
              ...
              <Card className="bg-white shadow-lg sticky top-24">
                <CardHeader>
                  <CardTitle className="text-[#4a7c59] flex items-center gap-2">
                    ...
                    Fredericksburg Service Area
                  </CardTitle>
                  <CardDescription>
                    We proudly serve Fredericksburg and the surrounding Spotsylvania County communities.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">We typically respond to Fredericksburg inquiries within 24 hours</p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-xs text-gray-600">
                      ...
                      <li>• Rappahannock River</li>
                      <li>• Civil War Battlefields</li>
                      <li>• Arts District</li>
                    </ul>
                  </div>
                </CardContent>
      ...
      <section className="py-16 bg-[#f5f1ed]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-[#2d3e2d] mb-12">
            What Fredericksburg Clients Say
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white border-l-4 border-[#d4a574]">
              <CardContent className="p-6">
                <p className="text-gray-600 italic mb-4">
                  &quot;We rented a sauna for our wedding at a historic venue in downtown Fredericksburg and it was absolutely magical. Our guests loved the unique wellness experience.&quot;
                </p>
                <p className="font-semibold text-[#4a7c59]">— Jennifer & Michael, Wedding Couple</p>
              </CardContent>
            </Card>
            <Card className="bg-white border-l-4 border-[#d4a574]">
              <CardContent className="p-6">
                <p className="text-gray-600 italic mb-4">
                  &quot;The sauna was perfect for our UMW alumni event. It added such a unique element to our gathering and everyone had a great time.&quot;
                </p>
                <p className="font-semibold text-[#4a7c59]">— Dr. Lisa Chen, UMW Alumni</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section id="contact" className="py-16 bg-[#f5f1ed]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-[#2d3e2d] mb-12">
            Book Your Fredericksburg Sauna Rental
          </h2>
          <div className="max-w-2xl mx-auto">
            <Card className="bg-gradient-to-r from-[#4a7c59] to-[#6a9c79] text-white text-center">
              <CardContent className="p-8">
                <h3 className="text-3xl font-bold mb-4">Ready to Experience Historic Wellness?</h3>
                <p className="text-lg mb-6">
                  Contact our Fredericksburg team today. We&apos;ll help you choose the perfect sauna rental package for your needs in Virginia&apos;s historic gem.
                </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/fredericksburg" className="text-[#d4a574] font-medium">Fredericksburg, VA</Link></li>
